//! Native connector ABI for Redis.
//!
...
const HEALTH_RESPONSE_JSON: &str =
    r#"{"ok":true,"engine":"redis","abiVersion":1,"driverLinked":false}"#;
const DESCRIBE_RESPONSE_JSON: &str = concat!(
    r#"{"ok":true,"engine":"redis","abiVersion":1,"driverLinked":false,"manifest":"#,
